  ...
  return (
    <>
      <div className="d-flex justify-content-between align-items-center mb-3">
        ...
        <Link className="btn btn-primary" to="/study-groups">Browse study groups</Link>
      </div>
        ...
        {courses.map((course) => (
          <div className="col-md-6" key={course.enrollment_id}>
            <div className="course-card">
              ...
              <Link className="btn btn-primary btn-sm" to={`/student/study-groups/${course.id}/learn`}>Open learning page</Link>
            </div>
          </div>
        ))}
      </div>
