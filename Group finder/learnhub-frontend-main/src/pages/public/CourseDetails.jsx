    ...
    <main className="page-shell">
      <div className="content-panel">
        ...
        <div className="row g-3 mb-3">
          <div className="col-md-3"><strong>Group leader</strong><br />{course.teacher_name}</div>
        ...
        {user?.role === 'student' ? (
          <button className="btn btn-success" onClick={handleEnroll}>Enroll in study group</button>
        ) : (
