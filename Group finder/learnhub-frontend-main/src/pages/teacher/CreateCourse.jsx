...
export default function CreateCourse() {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      navigate('/group-leader/study-groups');
    } catch (apiError) {
      setError(apiError.response?.data?.message || 'Could not create study group.');
    }
  }

  return (
    <div className="content-panel">
      <h1 className="h3">Create study group</h1>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button className="btn btn-primary mt-3">Save study group</button>
      </form>
    </div>
  );
}
